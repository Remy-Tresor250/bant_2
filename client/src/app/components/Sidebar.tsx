...
import { faHome, faBell, faHashtag, faInbox, faBookmark, faClipboard, faUser, faEllipsis } from "@fortawesome/free-solid-svg-icons";
...
const Sidebar = () => {
  return (
    ...
    >
      ...
      <button className={`${styles.flexCenter} bg-moderateBlue rounded-[10rem] px-[10%] py-[1rem] font-bold text-[1.1em]`}></button>
    </div>
  );
};
